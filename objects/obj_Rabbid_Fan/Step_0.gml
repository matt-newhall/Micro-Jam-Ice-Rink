...
if (place_meeting(x, y, obj_Player) && obj_Player.invuln == false && obj_Player.state != "in_jump") {
	obj_Game_Controller.handle_score_event("bd_fan_collision");
	obj_Player.invuln = true;
} else if (place_meeting(x, y, obj_Player) && obj_Player.invuln == false && !given_jump_bonus) {
